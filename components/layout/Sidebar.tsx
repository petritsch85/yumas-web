    ...
    items: [
      ...
      { labelKey: 'sidebar.nav.salesReports',   href: '/pl-reports/sales-reports',   icon: LineChart,   permKey: 'pl_reports',
        children: [
          ...
          { labelKey: 'sidebar.nav.lieferando',     href: '/pl-reports/sales-reports/lieferando', icon: Bike },
      ...
      { labelKey: 'sidebar.nav.datev', href: '/pl-reports/datev', icon: BookOpen, permKey: 'pl_reports' },
