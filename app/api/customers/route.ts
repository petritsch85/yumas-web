...
export async function POST(req: NextRequest) {
  try {
    const { company_name, extra_line, contact_name, street, postcode, city, po_number, att, leist_street, leist_postcode, leist_city } = await req.json();
    ...
    const { error } = await supabase
      ...
      .upsert({
        ...
        att:            att            || null,
        leist_street:   leist_street   || null,
        leist_postcode: leist_postcode || null,
        leist_city:     leist_city     || null,
