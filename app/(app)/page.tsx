...
export default function DashboardPage() {
  ...
  const QUICK_LINKS: QuickLink[] = [
    ...
    { labelKey: 'dashboard.quickLinks.delivery',     href: '/delivery?view=driver',     icon: Truck,           color: '#00838F', permKey: 'delivery' },
    { labelKey: 'dashboard.quickLinks.packing',      href: '/delivery?view=packer',     icon: Package,         color: '#0277BD', permKey: 'packer' },
